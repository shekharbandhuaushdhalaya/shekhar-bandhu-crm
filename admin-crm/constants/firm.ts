              ...
              )}
{
  licenseValidTill && new Date(licenseValidTill) < new Date() ? (
    <Text style= {{ fontSize: 9, color: colors.danger, marginTop: -8, marginBottom: 6 }
}>⚠ License has EXPIRED! Renew immediately.</Text>
              ) : licenseValidTill ? (
              ...
              )}
{
  gmpValidTill && new Date(gmpValidTill) < new Date() ? (
    <Text style= {{ fontSize: 9, color: colors.danger, marginTop: -8, marginBottom: 6 }
}>⚠ GMP Certificate has EXPIRED! Renew immediately.</Text>
              ) : gmpValidTill ? (
