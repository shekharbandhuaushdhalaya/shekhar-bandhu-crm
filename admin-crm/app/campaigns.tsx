            ...
            <View style={{ flexDirection: Platform.OS === 'web' ? 'row' : 'column', flex: 1, maxHeight: 600 }}>
              ...
              <ScrollView style={{ flex: 1, padding: Spacing.lg, backgroundColor: colors.bg.secondary }} contentContainerStyle={{ gap: 12 }}>
                <View style={styles.previewToggleRow}>
                  ...
                  <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flexGrow: 0, flexShrink: 0 }} contentContainerStyle={styles.previewPills}>
                    <TouchableOpacity 
...
const createStyles = (colors: typeof LightColors) =>
  StyleSheet.create({
    ...
    card: { backgroundColor: colors.bg.card, borderRadius: Radius.md, borderWidth: 0, padding: Spacing.md, position: 'relative' },
